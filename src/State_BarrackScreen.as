package  
{
	...
	public class State_BarrackScreen extends CGameState
	{
		...
		private static const BALLISTA_COST:int	= 4500;
		...
		override public function initialize(owner:DisplayObjectContainer):void 
		{
			...
			//unit story
			unit_story = [0, "Will produce 10 gold every 5 seconds.", 
							 ...
							 "He will summon a monster that will keep on moving until the edge of his own lane and kill enemy on sight. The old Ageesum will never chase anyone other than young girl with his ugly summoned monster." , "Feela likes to hunt little birds on his neighbour’s garden in his spare time",
							 ...
							 "This Unit hits horizontally and the damage affects all the enemies on the same lane."];
		...
		override public function enter():void 
		{
			...
			GlobalVars.LAST_STATE_LEEGOS = GlobalVars.UNLOCKED_MG;
			GlobalVars.LAST_STATE_SEELDY = GlobalVars.UNLOCKED_MED_CANNON
			GlobalVars.LAST_STATE_AGEESUM = GlobalVars.UNLOCKED_THROWER
			GlobalVars.LAST_STATE_FEELA = GlobalVars.UNLOCKED_MORTAR
			GlobalVars.LAST_STATE_ELONEE = GlobalVars.UNLOCKED_ROCKET
			GlobalVars.LAST_STATE_ENDROGEE = GlobalVars.UNLOCKED_BEAR_TRAP
			GlobalVars.LAST_STATE_UGEE = GlobalVars.UNLOCKED_GLUE_TRAP
			GlobalVars.LAST_STATE_BARRICADE = GlobalVars.UNLOCKED_HOLE_TRAP
			GlobalVars.LAST_STATE_TREASURY = GlobalVars.UNLOCKED_STONE_TRAP
			GlobalVars.LAST_STATE_TRAP = GlobalVars.UNLOCKED_TIMER_BOMB
			GlobalVars.LAST_STATE_BALLISTA = GlobalVars.UNLOCKED_TNT
			...
			for (var i:int = 0; i < 12 ; i++)
			{
				...
				Screen_Barrack["unit_" + i].addEventListener(MouseEvent.MOUSE_DOWN, onMouseClick);
				Screen_Barrack["unit_" + i].addEventListener(MouseEvent.MOUSE_UP, onMouseUp);
				Screen_Barrack["unit_" + i].addEventListener(MouseEvent.ROLL_OVER, onMouseOver);
				Screen_Barrack["unit_" + i].addEventListener(MouseEvent.ROLL_OUT, onMouseLeave);			
			}
			...
			TweenMax.killTweensOf(Screen_Barrack.goWar_btn);
			TweenMax.to(Screen_Barrack.goWar_btn, 0.5, { x:24, y: -70, ease:Back.easeInOut } );
			
			TweenMax.killTweensOf(Screen_Barrack.moreGames_btn);
			TweenMax.to(Screen_Barrack.moreGames_btn, 0.5, { x:0, y:Screen_Barrack.moreGames_btn.y, ease:Back.easeIn } );
			
			Screen_Barrack.moreGames_btn.addEventListener(MouseEvent.ROLL_OVER, onMouseOver);
			Screen_Barrack.moreGames_btn.addEventListener(MouseEvent.ROLL_OUT, onMouseLeave);
			Screen_Barrack.moreGames_btn.addEventListener(MouseEvent.MOUSE_DOWN, playMoreGame);
			
			if (!GlobalVars.HACK)
			{
				TweenMax.killTweensOf(Screen_Barrack.cheat_btn);
				TweenMax.to(Screen_Barrack.cheat_btn, 0.5, { x:0, y:Screen_Barrack.cheat_btn.y, ease:Back.easeIn } );
				Screen_Barrack.cheat_btn.addEventListener(MouseEvent.ROLL_OVER, onMouseOver);
				Screen_Barrack.cheat_btn.addEventListener(MouseEvent.ROLL_OUT, onMouseLeave);
				Screen_Barrack.cheat_btn.addEventListener(MouseEvent.MOUSE_DOWN, playCheatMode);
			}
		...
		private function update_icon():void
		{
			for (var j:int = 0; j < 12 ; j++)
			{
				...
				switch(unit_id)
				{
					...
					break;
					case 4:
					if (!GlobalVars.UNLOCKED_MED_CANNON)
					{
						Screen_Barrack["unit_" + j].icon.gotoAndStop(2);
						TweenMax.to(Screen_Barrack["unit_" + j], 0.25, {colorMatrixFilter:{colorize:0x000000, amount:0.7}});
					}
					...
					break;
					case 5:
					if (!GlobalVars.UNLOCKED_THROWER)
					{
						Screen_Barrack["unit_" + j].icon.gotoAndStop(2);
						TweenMax.to(Screen_Barrack["unit_" + j], 0.25, {colorMatrixFilter:{colorize:0x000000, amount:0.7}});
					}
					...
					break;
					case 8:
					if (!GlobalVars.UNLOCKED_BEAR_TRAP)
					{
						Screen_Barrack["unit_" + j].icon.gotoAndStop(2);
						TweenMax.to(Screen_Barrack["unit_" + j], 0.25, {colorMatrixFilter:{colorize:0x000000, amount:0.7}});
					}
					...
					break;
					case 9:
					if (!GlobalVars.UNLOCKED_GLUE_TRAP)
					{
						Screen_Barrack["unit_" + j].icon.gotoAndStop(2);
						TweenMax.to(Screen_Barrack["unit_" + j], 0.25, {colorMatrixFilter:{colorize:0x000000, amount:0.7}});
					}
					...
					break;
					case 10:
					if (!GlobalVars.UNLOCKED_HOLE_TRAP)
					{
						Screen_Barrack["unit_" + j].icon.gotoAndStop(2);
						TweenMax.to(Screen_Barrack["unit_" + j], 0.25, {colorMatrixFilter:{colorize:0x000000, amount:0.7}});
					}
					...
					break;
					case 11:
					if (!GlobalVars.UNLOCKED_TIMER_BOMB)
					{
						Screen_Barrack["unit_" + j].icon.gotoAndStop(2);
						TweenMax.to(Screen_Barrack["unit_" + j], 0.25, {colorMatrixFilter:{colorize:0x000000, amount:0.7}});
					}
		...
		override public function update(elapsedTime:int):void 
		{
			...
			if (warning_text != null)
			{
				...
				{
					trace(ticker);
					//TweenMax.killTweensOf(warning_text);
		...
		private function Recruit(selected:int):void
		{
			...
			switch(selected)
			{
				...
				if (!GlobalVars.UNLOCKED_MED_CANNON)
				{
					...
					{
						GlobalVars.RESEARCH_POINT -= unlock_point;
						GlobalVars.UNLOCKED_MED_CANNON = true;
					...
					else
					{
						if (warning_text == null)
						{
							...
							m_owner.addChild(warning_text);
							warning_text.notification.text = "not enough points to unlock!";
							trace(warning_text.notification.text);							
							warning_text.scaleX = warning_text.scaleY = 0;
							warning_text.x = 400;
							warning_text.y = 250;
							TweenMax.to(warning_text, 0.25, {scaleX:1, scaleY:1});
				...
				{
					GlobalVars.RESEARCH_POINT += unlock_point;
					GlobalVars.UNLOCKED_MED_CANNON = false;
					Screen_Barrack.recruit_btn.visible = true;
					Screen_Barrack.disband_btn.visible = false;
					unregisterButton(Screen_Barrack.disband_btn);
					/*if (warning_text == null)
				...
				if (!GlobalVars.UNLOCKED_THROWER)
				{
					...
					{
						GlobalVars.RESEARCH_POINT -= unlock_point;
						GlobalVars.UNLOCKED_THROWER = true;
				...
				{
					GlobalVars.RESEARCH_POINT += unlock_point;
					GlobalVars.UNLOCKED_THROWER = false;
					Screen_Barrack.recruit_btn.visible = true;
					Screen_Barrack.disband_btn.visible = false;
					unregisterButton(Screen_Barrack.disband_btn);
					/*if (warning_text == null)
				...
				if (!GlobalVars.UNLOCKED_MORTAR)
				{
					...
					{
						GlobalVars.RESEARCH_POINT -= unlock_point;
						GlobalVars.UNLOCKED_MORTAR = true;
				...
				{
					GlobalVars.RESEARCH_POINT += unlock_point;
					GlobalVars.UNLOCKED_MORTAR = false;
					Screen_Barrack.recruit_btn.visible = true;
					Screen_Barrack.disband_btn.visible = false;
					unregisterButton(Screen_Barrack.disband_btn);
					/*if (warning_text == null)
				...
				if (!GlobalVars.UNLOCKED_ROCKET)
				{
					...
					{
						GlobalVars.RESEARCH_POINT -= unlock_point;
						GlobalVars.UNLOCKED_ROCKET = true;
				...
				{
					GlobalVars.RESEARCH_POINT += unlock_point;
					GlobalVars.UNLOCKED_ROCKET = false;
					Screen_Barrack.recruit_btn.visible = true;
					Screen_Barrack.disband_btn.visible = false;
					unregisterButton(Screen_Barrack.disband_btn);
					/*if (warning_text == null)
				...
				if (!GlobalVars.UNLOCKED_BEAR_TRAP)
				{
					...
					{
						GlobalVars.RESEARCH_POINT -= unlock_point;
						GlobalVars.UNLOCKED_BEAR_TRAP = true;
				...
				{
					GlobalVars.RESEARCH_POINT += unlock_point;
					GlobalVars.UNLOCKED_BEAR_TRAP = false;
					Screen_Barrack.recruit_btn.visible = true;
					Screen_Barrack.disband_btn.visible = false;
					unregisterButton(Screen_Barrack.disband_btn);
					/*if (warning_text == null)
				...
				if (!GlobalVars.UNLOCKED_GLUE_TRAP)
				{
					...
					{
						GlobalVars.RESEARCH_POINT -= unlock_point;
						GlobalVars.UNLOCKED_GLUE_TRAP = true;
				...
				{
					GlobalVars.RESEARCH_POINT += unlock_point;
					GlobalVars.UNLOCKED_GLUE_TRAP = false;
					Screen_Barrack.recruit_btn.visible = true;
					Screen_Barrack.disband_btn.visible = false;
					unregisterButton(Screen_Barrack.disband_btn);
					/*if (warning_text == null)
				...
				if (!GlobalVars.UNLOCKED_HOLE_TRAP)
				{
					...
					{
						GlobalVars.RESEARCH_POINT -= unlock_point;
						GlobalVars.UNLOCKED_HOLE_TRAP = true;
				...
				{
					GlobalVars.RESEARCH_POINT += unlock_point;
					GlobalVars.UNLOCKED_HOLE_TRAP = false;
					Screen_Barrack.recruit_btn.visible = true;
					Screen_Barrack.disband_btn.visible = false;
					unregisterButton(Screen_Barrack.disband_btn);
					/*if (warning_text == null)
				...
				if (!GlobalVars.UNLOCKED_TIMER_BOMB)
				{
					...
					{
						GlobalVars.RESEARCH_POINT -= unlock_point;
						GlobalVars.UNLOCKED_TIMER_BOMB = true;
				...
				{
					GlobalVars.RESEARCH_POINT += unlock_point;
					GlobalVars.UNLOCKED_TIMER_BOMB = false;
					Screen_Barrack.recruit_btn.visible = true;
					Screen_Barrack.disband_btn.visible = false;
					unregisterButton(Screen_Barrack.disband_btn);
					/*if (warning_text == null)
		...
		private function playMoreGame(event:MouseEvent):void
		{
