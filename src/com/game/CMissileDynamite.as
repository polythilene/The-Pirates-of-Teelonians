package com.game
{
	 ...
	 */
	public class CMissileDynamite extends CBaseParabolicMissile
	{
		private var enemy_gotHit:Array = new Array() //siput
		
		public function CMissileDynamite(){}
		
		override public function initialize():void 
		{
			super.initialize();
			m_sprite = new mc_Dynamite();
		...
		protected function delayGrenade():void
		{
