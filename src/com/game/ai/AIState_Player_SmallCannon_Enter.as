package com.game.ai 
{
	 ...
	 * @author Wiwit
	 */
	public class AIState_Player_SmallCannon_Enter extends AIState
	{
		static private var m_instance:AIState_Player_SmallCannon_Enter;
		
		public function AIState_Player_SmallCannon_Enter(lock:SingletonLock) 
		{
			m_stateName ="AIState_Player_SmallCannon_Enter"
		...
		override public function update(npc:CBaseTeelos, elapsedTime:int):void 
		{
			...
			if (CPlayerTeelos(npc).m_cranePlacing.currentFrame == 2 && CPlayerTeelos(npc).craneAnimationDone())
			{
				...
				npc.changeAIState(AIState_Player_SmallCannon_Prepare.getInstance());
		...
		static public function getInstance() : AIState_Player_SmallCannon_Enter 
		{
			if ( m_instance == null )
			{
            	m_instance = new AIState_Player_SmallCannon_Enter( new SingletonLock() );
            }
			return m_instance;
		}
	}
