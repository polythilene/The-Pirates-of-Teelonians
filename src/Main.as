package 
{
	...
	public class Main extends Sprite 
	{
		...
		private function init(e:Event = null):void 
		{
			...
			State_PlanScreen.getInstance().initialize(stage);
			State_MiniGame.getInstance().initialize(stage);
			...
			State_TutorialScreen.getInstance().initialize(stage);
			*/
		...
		private function start(event:Event):void
		{
			...
			GameStateManager.getInstance().setState(State_MiniGame.getInstance());
			//GameStateManager.getInstance().setState( State_MiniGame.getInstance() );
