...
package com.game
{
	...
	public class CTeeloBaseSummoned extends CPlayerTeelos
	{
		...
		override public function onCreate(lane:int, xPos:int, container:DisplayObjectContainer):void 
		{
			...
			var dice:int = OpMath.randomNumber(90);
			
			if ( dice < 50 )
				SoundManager.getInstance().playSFX("SNSummon01");
			/*else if ( dice > 30 && dice < 60 )
				SoundManager.getInstance().playSFX("SNSummon02");*/
			else
				SoundManager.getInstance().playSFX("SNSummon03");
		}
