package com.game.ai 
{
	 ...
	 * @author Wiwit
	 */
	public class AIState_Captain_Walk extends AIState
	{
		static private var m_instance:AIState_Captain_Walk;
		
		public function AIState_Captain_Walk(lock:SingletonLock) 
		{
			m_stateName ="AIState_Captain_Walk"
		...
		static public function getInstance() : AIState_Captain_Walk 
		{
			if ( m_instance == null )
			{
            	m_instance = new AIState_Captain_Walk( new SingletonLock() );
            }
			return m_instance;
		}
