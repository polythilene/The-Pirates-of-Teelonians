package com.game.physics 
{
	 ...
	 * @author Wiwit
	 */
	public class CBouncingBullet extends CBasePhysicBullet
	{
		static private var m_bulletSD:b2CircleDef;
		static private var m_bulletBD:b2BodyDef;
		
		private var bounce:Boolean;
		private var explodeDelay:int;
		
		public function CBouncingBullet(x:int, y:int, angle:Number, power:Number, ratio:int, bodyDef:b2BodyDef, shapeDef:b2ShapeDef, world:b2World, container:DisplayObjectContainer) 
		{
		...
		private function setupBulletDefinition():void 
		{
			...
			m_bulletSD.friction = 0.85;
			m_bulletSD.restitution = 1;
